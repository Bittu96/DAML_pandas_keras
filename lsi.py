d1 = "ram and shyam"
d2 = "shyam used a dagger"
d3 = "ram die by dagger"
d4 = "live free or die that is the motto of 'new-town'"
d5 = "did you know, new-town is in kolkata?"
...
D = pd.DataFrame(dtm.toarray(),index=example,columns=vectorizer.get_feature_names
()).head(10)
#D = pd.DataFrame(dtm.toarray())#,columns=vectorizer.get_feature_names())
print D
L,s,R = linalg.svd(mat(D))
#print mat(D)*mat(D.T)
w, v = linalg.eig(mat(D)*mat(D.T))
#print sqrt(w)
#print v 
print mat(L)#,s,R